...
static const Block blocks[] = {
    ...
    {"^d^ ^b#d65d0e^^c#1d2021^  ^b#fe8019^ ", "df -h | grep zroot/ROOT/default | awk '{print $4}'",					21600,	 10},
    {"^d^ ^b#b16286^^c#1d2021^  ^b#d3869b^ ", "uname -r | cut -c 1-4",							0,	 12},
    {"^d^ ^b#98971a^^c#1d2021^  ^b#b8bb26^ ", "pamixer --get-volume",    						1,	 0},
    {"^d^ ^b#d79921^^c#1d2021^  ^b#fabd2f^ ", "~/.local/scripts/sb/sb-battery",  					60,	 0},
    {"^d^ ^b#689d6a^^c#1d2021^  ^b#8ec07c^ ", "~/.local/scripts/sb/sb-mem",    						10,	 0},
    {"^d^ ^b#cc241d^^c#1d2021^  ^b#fb4934^ ", "date +'%H:%M'",					60,	 0},
    {"^d^ ", "",					0,	 0},
